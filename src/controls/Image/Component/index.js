            ...
            <div onClick={this.fileUploadClick}>
              ...
              >
                ...
                >
                  ...
                  { imgSrc && (!previewImage || !isImage(imgSrc)) && <span className={`rdw-image-modal-upload-option-file-preview wysiwyg__file-icon file-is-${getFileExtension(imgSrc)}`}>{imgSrc}</span> }
                </label>
              </div>
              <input
                type="file"
